...
def run(
    ...
    df = pd.DataFrame(columns=["File_name", "Success", "Note"])
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        person_counter = 0
        success_path = Path('/home/selectstar/yolov5/runs/police_success')
        failed_path = Path('/home/selectstar/yolov5/runs/police_failed')
        results = {}
        ...
        # Print results
                excluded_classes = ["bird", "cat", "dog", "horse", "sheep", "cow", "elephant", "bear", "zebra", "giraffe",]
                excluded_count = 0
        ...
        # Write results
            ...
            # Check conditions and save to appropriate folder
            
            if person_counter == 1 and excluded_count == 0:
                print(f"Image height: {image_height}, y_min: {y_min_pixel}, y_max: {y_max_pixel}, height: {y_max_pixel - y_min_pixel}")
            ...
            current_result = pd.DataFrame([[file_name, success, Note]], columns=["File_name", "Success","Note"])
...
# Step 3: After processing all images, save the DataFrame to a CSV file
    csv_file_path = '/home/selectstar/yolov5/runs/output.csv'  # 원하는 CSV 파일 경로로 변경
